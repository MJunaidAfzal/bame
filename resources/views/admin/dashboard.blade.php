                ...
                <div class="swiper-wrapper" id="swiper-wrapper-b4c76e08c6569311" aria-live="off" style="transform: translate3d(-1782px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" style="width: 594px;" role="group" aria-label="3 / 3">
                    <div class="row">
                      <div class="col-12">
                        ...
                        <small style="color: #30E36D">Total 28.5% Conversion Rate</small>
                      </div>
              ...
              ;border:#30E36D 2px groove" class="card">
                <div class="card-header">
                  <div class="d-flex justify-content-between">
                    ...
                    <p style="color: #30E36D" class="card-text text-success">+18.2%</p>
                  </div>
                  <h4 style="color: #30E36D" class="card-title mb-1">$42.5k</h4>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-4">
                      <div class="d-flex gap-2 align-items-center mb-2">
                        ...
                        <p style="color: white" class="mb-0">Order</p>
                      </div>
                      <h5 style="color: #30E36D" class="mb-0 pt-1 text-nowrap">62.2%</h5>
                      <small style="color: white" class="text-muted">6,440</small>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-4 text-end">
                      <div class="d-flex gap-2 justify-content-end align-items-center mb-2">
                        <p style="color: white" class="mb-0">Visits</p>
                        <span class="badge bg-label-primary p-1 rounded"><i class="fa fa-link ti-xs"></i></span>
                      </div>
                      <h5 style="color: #30E36D" class="mb-0 pt-1 text-nowrap ms-lg-n3 ms-xl-0">25.5%</h5>
                      <small style="color: white" class="text-muted">12,749</small>
                    </div>
                  </div>
