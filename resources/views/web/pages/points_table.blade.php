...
@section('content')
  ...
  <div style="margin-top:150px;" class="breadcumb-wrapper" data-bg-src="{{asset('assets/img/bg/bg1.avif')}}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">POINT TABLE</h1>
    ...
    <div class="point-table-area-1 space overflow-hidden" data-bg-src="{{asset('assets/img/bg/tournament-table-sec1-bg.png')}}">
        <div class="container">
            <div class="title-area text-center custom-anim-top wow animated" data-wow-duration="1.5s"
                data-wow-delay="0.2s"><span class="sub-title style2"># Point Table</span>
            ...
            <div class="table-responsive">
                <table class="table tournament-table">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-1.png')}}" alt="img">PRO
                                    Player</a></td>
                            <td>4</td>
                            <td>0</td>
                            <td>21</td>
                        ...
                        <tr>
                            <th scope="row">2</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-2.png')}}" alt="img">The
                                    Lion King</a></td>
                            <td>4</td>
                            <td>1</td>
                            <td>29</td>
                        ...
                        <tr>
                            <th scope="row">3</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-3.png')}}" alt="img">The
                                    Assassin King</a></td>
                            <td>4</td>
                            <td>1</td>
                            <td>25</td>
                        ...
                        <tr>
                            <th scope="row">4</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-4.png')}}"
                        ...
                        <tr>
                            <th scope="row">5</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-5.png')}}" alt="img">Team
                                    Gorilla</a></td>
                            <td>4</td>
                            <td>1</td>
                            <td>24</td>
                        ...
                        <tr>
                            <th scope="row">6</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-6.png')}}" alt="img">King Of
                                    Badgamer</a></td>
                            <td>4</td>
                            <td>0</td>
                            <td>17</td>
                        ...
                        <tr>
                            <th scope="row">7</th>
                            <td><a href="tournament.html.htm"><img src="{{asset('assets/img/tournament/1-7.png')}}" alt="img">Team
                                    Ninja</a></td>
                            <td>4</td>
                            <td>0</td>
                            <td>18</td>
