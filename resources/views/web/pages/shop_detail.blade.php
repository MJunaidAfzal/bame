...
@section('content')
    ...
    <div style="margin-top:150px;" class="breadcumb-wrapper" data-bg-src="{{asset('assets/img/bg/bg12.jpg')}}">
        <div class="container">
        ...
        <div class="container">
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="{{asset('assets/img/product/product_details_1_1.png')}}" alt="Product Image">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-about">
                        ...
                        <div class="product-rating">
                            <div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span
                                    style="width:100%">Rated <strong class="rating">4.00</strong> out of 5 based on
                                    <span class="rating">1</span> customer rating</span></div><a
                                href="shop-details.html.htm" class="woocommerce-review-link">(<span
                        ...
                        <div class="mt-2 link-inherit">
                            <p><strong class="text-white me-3">Availability:</strong> <span class="stock in-stock"><i
                        ...
                        <div class="actions">
                            ...
                            <button class="th-btn">Add to Cart <span class="icon"><i
                                        class="fa-solid fa-arrow-right ms-2"></i></span></button> <a
                                href="wishlist.html.htm" class="icon-btn"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product_meta"><span class="sku_wrapper">SKU: <span
                                ...
                                <a href="shop.html.htm">Dresses & Bags</a></span> <span>Tags: <a
                                    href="shop.html.htm">Product</a><a href="shop.html.htm">Bags</a></span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="productTabContent">
                <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                    <p class="mt-n2">Prepare to embark on a sensory journey with the Bosco Apple, a fruit that
                        transcends the ordinary and promises an unparalleled taste experience. These apples are nothing
                        short of nature’s masterpiece, celebrated for their distinctive blend of flavors and their
                        captivating visual allure. Bosco Apples are a revelation for your taste buds. Their impeccable
                        balance of sweetness and tartness creates a complex, layered taste profile that keeps you coming
                        back for more. Each bite is a symphony of sweet and tangy notes, making these apples a
                        gastronomic delight whether enjoyed fresh or as a key ingredient in your favorite culinary
                        creations.</p>
                    <p>The Bosco Apple is not just a fruit; it’s a work of art. Its striking, deep red skin is adorned
                        with intricate speckles, making it a showstopper in the world of fruit aesthetics. Display these
                        apples with pride in your kitchen, and you’ll undoubtedly draw admiration from all who see them.
                        We take our commitment to the environment seriously. Bosco Apples are cultivated on eco-friendly
                        orchards that prioritize sustainable farming practices. You can savor these apples knowing they
                        are grown with respect for the planet, aligning with your values of environmental
                        responsibility. Whether you’re a culinary aficionado or a casual home chef, Bosco Apples offer
                        limitless possibilities in the kitchen. Slice them into a vibrant salad, transform them into
                        mouthwatering pies, or blend them into wholesome applesauce. The culinary canvas is yours to
                        paint with these versatile apples.</p>
                </div>
                    ...
                    <div class="woocommerce-Reviews">
                        ...
                        <div class="th-comment-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group style-border"><textarea placeholder="Write a Message"
                                        class="form-control"></textarea> <i class="far fa-pencil-alt"></i></div>
                                ...
                                <div class="col-md-6 form-group style-border"><input type="text"
                                        placeholder="Your Email" class="form-control"> <i class="far fa-envelope"></i>
                                </div>
                                ...
                                <div class="col-12 form-group mb-0"><button class="th-btn">Post Review <span
                                            class="icon"><i class="fa-solid fa-arrow-right ms-2"></i></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_1.png')}}"
                                        alt="Product Image">
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">Gaming Headphone</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_2.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_3.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">Gaming Keyboard</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_4.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_5.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">Microphone G9000</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_6.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">Play Station
                                            Controller</a></h3><span class="price">$30.85</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_7.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">PlayStation VR</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img"><img src="{{asset('assets/img/product/product_1_8.png')}}"
                                        alt="Product Image">
                                    <div class="overlay gradient-border"></div>
                                    <div class="actions"><a href="cart.html.htm" class="icon-btn"><i
                                                class="far fa-cart-plus"></i></a> <a href="wishlist.html.htm"
                                ...
                                <div class="product-content">
                                    <h3 class="product-title"><a href="shop-details.html.htm">Wireless speaker</a></h3>
