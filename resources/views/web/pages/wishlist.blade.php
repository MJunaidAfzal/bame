...
@section('content')
    ...
    <div style="margin-top: 150px" class="breadcumb-wrapper" data-bg-src="{{asset('assets/img/bg/bg4.jpg')}}">
        <div class="container">
        ...
        <div class="container">
            <div class="tinv-wishlist woocommerce tinv-wishlist-clear">
                <div class="tinv-header">
                    <h2 class="mb-30 text-white">Wishlist</h2>
                </div>
                    ...
                    <table class="tinvwl-table-manage-list">
                        ...
                        <tbody>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail"><a href="shop-details.html.htm"><img
                                            src="{{asset('assets/img/product/product_thumb_1_1.png')}}"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a></td>
                                <td class="product-name"><a href="shop-details.html.htm">Gaming Headphone</a></td>
                                ...
                                <td class="product-action"><button class="button icon-btn" name="tinvwl-add-to-cart"
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-remove"><button type="submit" name="tinvwl-remove" value="60"
                                        title="Remove"><i class="fal fa-times"></i></button></td>
                                <td class="product-thumbnail"><a href="shop-details.html.htm"><img
                                            src="{{asset('assets/img/product/product_thumb_1_2.png')}}"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a></td>
                                <td class="product-name"><a href="shop-details.html.htm">Gaming Mouse</a></td>
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-remove"><button type="submit" name="tinvwl-remove" value="60"
                                        title="Remove"><i class="fal fa-times"></i></button></td>
                                <td class="product-thumbnail"><a href="shop-details.html.htm"><img
                                            src="{{asset('assets/img/product/product_thumb_1_3.png')}}"
                                            class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                            alt="image"></a></td>
                                <td class="product-name"><a href="shop-details.html.htm">Gaming Keyboard</a></td>
                                <td class="product-price"><ins><span class="woocommerce-Price-amount amount"><bdi><span
                                                    class="woocommerce-Price-currencySymbol">$</span>18.00</bdi></span></ins>
                                    <del><span class="woocommerce-Price-amount amount"><bdi><span
                                                    class="woocommerce-Price-currencySymbol">$</span>20.00</bdi></span></del>
                ...
                <div class="social-buttons"><span class="text-white">Share on</span>
                    <ul>
