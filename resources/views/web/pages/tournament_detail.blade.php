...
@section('content')
    ...
    <div style="margin-top: 150px;" class="breadcumb-wrapper" data-bg-src="{{asset('assets/img/bg/bg8.jpg')}}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">TOURNAMENT MATCH DETAILS</h1>
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('index') }}">Home</a></li>
                    <li>TOURNAMENT MATCH DETAILS</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row gx-40">
                ...
                <div class="col-lg-8">
                    <div class="page-single tournament-details-wrap">
                        <div class="page-content">
                            <h2 class="sec-title page-title h3">ESC Season 8 – Opening Match</h2>
                            <div class="tournament-meta">All matches, latest results / 4th Jan 2024, 12:00</div>
                            <p class="">Gamers can join local gaming meetups, participate in gaming events, or connect
                                with like-minded individuals through online forums and social media groups. Engaging
                                with the community helps build connections and creates opportunities for collaborative
                                gaming experiences.</p>
                            <p class="mb-30">Emerging trends in the esports industry include the growth of mobile
                                esports, the integration of virtual reality in gaming experiences, and the increasing
                                involvement of traditional sports organizations in esports partnerships and investments.
                            </p>
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="page-img"><img class="w-100"
                                            src="{{asset('assets/img/tournament/tournament-s-1-1.png')}}" alt="img"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="page-img"><img class="w-100"
                                            src="{{asset('assets/img/tournament/tournament-s-1-2.png')}}" alt="img"></div>
                                </div>
                            </div>
                            <p class="mb-n2 mt-35">Storytelling is a crucial element in modern video game design,
                                creating immersive and engaging experiences. Games with compelling narratives often
                                resonate more with players, adding depth to the overall gaming experience.</p>
                            <div class="tournament-team-list">
                                <ul class="tournament-single-team-list">
                                    ...
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-1.png')}}" alt="img"> Avishek</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-2.png')}}" alt="img"> Elius</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-3.png')}}" alt="img"> Alex</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-4.png')}}" alt="img"> Eshika</li>
                                </ul>
                                <ul class="tournament-single-team-list">
                                    <li>
                                    ...
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-5.png')}}" alt="img"> Michel</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-6.png')}}" alt="img"> Rachid</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-7.png')}}" alt="img"> Kamily</li>
                                    <li class="tournament-single-team"><img
                                            src="{{asset('assets/img/tournament/tournament-s-team1-8.png')}}" alt="img"> Henry</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <aside class="sidebar-area">
                            ...
                            <div class="widget-tournament-info">
                                <div class="next-match-list">
                                    <div class="player-info">
                                        <div class="player-logo"><img src="{{asset('assets/img/tournament/1-3.png')}}" alt="img">
                                        </div>
                                        <h4 class="player-title"><a href="team-details.html.htm">Assassin</a></h4>
                                    ...
                                    <div class="player-info">
                                        <div class="player-logo"><img src="{{asset('assets/img/tournament/1-6.png')}}" alt="img">
                                        </div>
                                        <h4 class="player-title"><a href="team-details.html.htm">Badgamer</a></h4>
                                        <div class="player-social"><span>Watch</span> <a
                                                href="https://www.twitch.tv/"><i class="fa-brands fa-twitch"></i></a> <a
                                                href="https://www.youtube/"><i class="fa-brands fa-youtube"></i></a>
                                        </div>
                        ...
                        <div class="widget">
                            <h3 class="widget_title">Advertisement</h3><a href="tournament.html.htm"
                                class="widget-advertise text-center"><img src="{{asset('assets/img/widget/widget-ad.png')}}"
                                    alt="img"></a>
                        </div>
                        <div class="widget">
                            <h3 class="widget_title">Winner of Last Session</h3>
                            <div class="widget-banner text-center">
                                <div class="logo"><img src="{{asset('assets/img/tournament/1-9.png')}}" alt="img"></div>
